...
public class AdminNavigationBarPage {
    ...
    private CupManagementPage cupManagementPage; // Deklarasi variabel cupManagementPage di tingkat kelas
    ...
    private void init() {
        ...
        cupManagementPage = new CupManagementPage(); // Inisialisasi variabel cupManagementPage
